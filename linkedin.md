...
I'm a software developer. I used AI throughout, to go faster and to work in areas where my experience was thinner. The architecture, the decisions, the features I was still adding the night before the event: that was mine.
...
One repo. One Vercel deployment. The admin dashboard, scanner, and ticketing flow all shared the same API layer and environment. One set of secrets, no coordination overhead.
